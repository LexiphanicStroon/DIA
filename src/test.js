    ...
    entries.forEach((entry) => {
      if (entry.isIntersecting) {
        ...
        switch (entry.target.id) {
          case 'home':            
            document.querySelector('#menu a[href="#home"]').classList.remove('bg-dark-blue');
            document.querySelector('#menu a[href="#home"]').classList.add('bg-electric-blue');
            break;
          case 'services':            
            document.querySelector('#menu a[href="#services"]').classList.remove('bg-dark-blue');
            document.querySelector('#menu a[href="#services"]').classList.add('bg-electric-blue');
            break;
          case 'about':            
            document.querySelector('#menu a[href="#about"]').classList.remove('bg-dark-blue');
            document.querySelector('#menu a[href="#about"]').classList.add('bg-electric-blue');
            break;
          case 'contact':            
            document.querySelector('#menu a[href="#contact"]').classList.remove('bg-dark-blue');
            document.querySelector('#menu a[href="#contact"]').classList.add('bg-electric-blue');
            break;
        }
      }
    });
